...
/**
 * CREATE TABLE SolarCurrentState ( siteId VARCHAR(15), currentPower
 * decimal(10,5) unsigned, totalPower decimal(20,5) unsigned, date timestamp,
 * unit VARCHAR(10), measuredBy VARCHAR(15) )ENGINE=InnoDB DEFAULT CHARSET=utf8;
 */