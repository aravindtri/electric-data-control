...
public class CurrentVehicleStateDTO {
	...
	private String vin;
	private double batteryLevel, miles, batteryRange,latitude,longitude,insideTemp,estBatteryRange,idealBatteryRange,heading; //133.28
	//35.057878
...
CREATE TABLE VehicleData (
  ...
  vehicleId INT,
  date timestamp,
  miles decimal(14,7) unsigned,
  batteryLevel decimal(6,3) unsigned,
  batteryRange decimal(7,3) unsigned,
  estBatteryRange decimal(7,3) unsigned,
  idealBatteryRange decimal(7,3) unsigned,
  latitude decimal(11, 8),
  longitude decimal(11, 8),
  heading decimal(11, 8),
  insideTemp decimal(5,2)
